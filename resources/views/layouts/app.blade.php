        ...
        <div id="carouselExampleIndicators" class="carousel slide">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="Avril.jpg" class="d-block w-100"width="100%" height="450px" alt="...">
              </div>
              <div class="carousel-item">
                <img src="nungki.jpeg" class="d-block w-100" width="100%" height=450px alt="...">
              </div>
              <div class="carousel-item">
                <img src="cauple.jpg" class="d-block" width="100%" height="450px" alt="...">
              </div>
            </div>
